...
> = {
  createTheater?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateTheaterArgs, "artisticDirector">
  >;
  deleteTheater?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteTheaterArgs, "id">
  >;
};
...
> = {
  theaters?: Resolver<
    Array<ResolversTypes["Theater"]>,
    ParentType,
    ContextType
  >;
};

export type TheaterResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Theater"] = ResolversParentTypes["Theater"]
> = {
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  artisticDirector?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
